 ...
 *    - displayList displays a list like this: {alpha}{beta}{gamma}
...
/* newNode
 *     - create a node that holds an char * value
 */
...
/* head
 *     - return the first string value in the list
 */
...
/* setHead
 *     - replace the first string value in the list
 */
...
/* join
 *     - join an string value to a list
 */
...
/*
 * readList 
 *      - reads in a list of tokens into a list
 *      - the input should look like: (alpha,beta,gamma,delta,iota)
 */
