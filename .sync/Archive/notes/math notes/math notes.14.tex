...
\paragraph{7.3 composition of functions}Def : let $ F: X -> Y $ and $ g: Y -> Z $ such that the range of f is contained in the domain of g  \\ then $gof: x->Z $ is defined as $ (gof) (x) = g( f(x)) $ for all $ x \in X $ 
\end{document} 